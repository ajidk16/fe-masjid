...
<main class="space-y-5 px-4 pt-6">
	<section class="flex items-center justify-between">
		<h1 class="text-2xl font-semibold">Order Status</h1>
	...
	<section class="card">
		...
		>
			<p class="font-medium">Daftar Order Status</p>
			...
			<div class="flex items-center gap-2">
				{#if donations.pagination.total > donations.pagination.limit}
					<button
						...
						onclick={() =>
							goto(`/admin/references/order-status?page=${donations.pagination.page - 1}`)}
					>
						Sebelumnya
					</button>
					<button
